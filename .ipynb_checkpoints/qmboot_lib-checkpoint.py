...
working_directory = os.getcwd() # directory of data files, python files, etc
...
output_data_directory = osp.join(working_directory,'data')
if not osp.exists(output_data_directory):
    os.mkdir(output_data_directory)  # directory for data to be placed in and read from
